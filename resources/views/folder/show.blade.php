    ...
    <div class="flex items-center justify-center bg-white mb-5 shadow-xl sm:rounded-lg p-6">
        <div class="mx-auto w-full">
            ...
            <div class="flex flex-wrap items-end">
                ...
                <div class="w-full px-0 sm:px-3 flex justify-center items-strech sm:w-1/4 space-x-2">
                    <button type="button" wire:click="applyFilter" class="w-1/2 py-3 rounded-md bg-teal-600  hover:bg-teal-700 text-center text-xs font-semibold text-white outline-none hover:shadow-form">
                        Appliquer
                    </button>
                    <button type="button" wire:click="resetFilter" class="w-1/2 py-3 rounded-md bg-gray-400 hover:bg-gray-500 text-center text-xs font-semibold text-white outline-none hover:shadow-form">
                        Réinitialiser
                    </button>
                </div>
            </div>
                ...
                <x-slot name="tbody" class="relative">
                    ...
                    <tr class="border-b-2 border-gray-50 last:border-b-0">
                        ...
                        <td class="p-2 text-left align-middle whitespace-nowrap ">
                            ...
                            <p wire:loading class="w-{{ $skeletonWidths[rand(0, count($skeletonWidths) - 1)] }} animate-pulse bg-gray-400 h-3 rounded-full">
                            </p>
                        </td>
                        <td class="p-2 pl-6 text-left align-middle whitespace-nowrap">
