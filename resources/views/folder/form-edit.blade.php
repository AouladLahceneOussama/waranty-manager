        ...
        <div class="w-full p-4 mb-4 bg-teal-50 rounded">
            ...
            <div class="flex flex-wrap -mx-3 mb-4">
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <label class="block uppercase tracking-wide text-gray-500 text-xs font-bold mb-1"
                        for="numero_adheration">
                        {{ __('Numero adheration') }}
                    </label>
                    <input wire:model="folder.numero_adheration" type="text"
                        class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
        ...
        <div class="w-full p-4 mb-4 bg-teal-50 rounded">
            ...
            <div class="flex flex-wrap -mx-3 mb-4">
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <input wire:model="insureds.primary.0.prenom" type="text"
                        class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
            ...
            <div class="flex flex-wrap -mx-3 mb-4">
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <input wire:model="insureds.primary.0.code_securite_social" type="text"
                        {{ !in_array('editPrimaryAsured', $activatedSection) ? 'disabled' : '' }}
                        class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
            ...
            <div class="flex flex-wrap -mx-3 mb-4">
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <input wire:model="insureds.primary.0.primary_phone" type="tel"
                        class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <input wire:model="insureds.primary.0.secondary_phone" type="tel"
                        class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <input wire:model="insureds.primary.0.email" type="email"
                        class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
            ...
            <div class="flex flex-wrap -mx-3 mb-4">
                ...
                <div class="w-full md:w-2/3 px-3 mb-6 md:mb-0">
                    ...
                    <input wire:model="insureds.primary.0.iban" type="text"
                        class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <div class="flex items-center">
                        <input wire:model="prelevement" id="disabled-radio-2" type="radio" value="5"
                        ...
                        <input wire:model="prelevement"id="disabled-radio-2" type="radio" value="10"
                            value="10" name="disabled-radio"
                            class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 focus:ring-blue-500   focus:ring-2"
                            {{ !in_array('editPrimaryAsured', $activatedSection) ? 'disabled' : '' }}>
                        <label for="disabled-radio-2" class="mx-2 text-sm font-medium text-gray-700 ">10</label>

                        <input wire:model="prelevement" id="disabled-radio-2" type="radio" value="15"
            ...
            <div class="w-full">
                ...
                <div class="flex flex-wrap -mx-3 mb-4">
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input wire:model="insureds.secondary.0.nom" type="text"
                            class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
                            placeholder="Nom de l'assuré" id="nom"
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input wire:model="insureds.secondary.0.prenom" type="text"
                            class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
                            placeholder="Prénom de l'assuré" id="prenom"
                            {{ !in_array('editSecondaryAsured', $activatedSection) ? 'disabled' : '' }} />
                        @error('prenom')
                ...
                <div class="flex flex-wrap -mx-3 mb-4">
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <select wire:model="insureds.secondary.0.civilite"
                            {{ !in_array('editSecondaryAsured', $activatedSection) ? 'disabled' : '' }}
                            class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
                            placeholder="Date de naissance" id="civilite">
                            <Option>M.</Option>
                            ...
                            <div class="flex flex-wrap -mx-3 mb-4">
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                    ...
                                    <select wire:model="insureds.children.{{ $key }}.civilite"
                                        ...
                                        id="civilite_enf_{{ $key }} {{ !in_array('editChild' . $key, $activatedSection) ? 'disabled' : '' }}">
                                        <Option>M.</Option>
                                        <Option>Mme</Option>
                                        <Option>Mlle</Option>
                                    </select>
