<div>
    <form class="w-full py-2 px-8 mt-4 h-full">
        <div class="w-full mb-3">
            <span class="text-indigo-700 text-xl ">{{ __('Informations générales') }}</span>
            ...
            <div class="w-full  md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <div class="flex  items-center">
                    <label class="inline-flex relative items-center cursor-pointer">
                        ...
                        <span class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-500">Dossier Complet</span>
                    </label>
        ...
        <div class="w-full mb-3">
            <div class="flex justify-between items-center">
                <span class="text-indigo-700 text-xl ">{{ __('Informations de l\'assuré principal') }}</span>
        ...
        <div class="flex flex-wrap -mx-3 mb-4">
            ...
            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <div class="flex items-center">
                    <input wire:model="insureds.primary.jours_prelevement" id="disabled-radio-2" type="radio" value="5"
                        name="disabled-radio"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="disabled-radio-2"
                        class="mx-2 text-sm font-medium text-gray-700 dark:text-gray-500">5</label>

                    <input wire:model="insureds.primary.jours_prelevement"id="disabled-radio-2" type="radio" value="10"
                        name="disabled-radio"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="disabled-radio-2"
                        class="mx-2 text-sm font-medium text-gray-700 dark:text-gray-500">10</label>

                    <input wire:model="insureds.primary.jours_prelevement" id="disabled-radio-2" type="radio" value="15"
                        name="disabled-radio"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="disabled-radio-2"
                        class="mx-2 text-sm font-medium text-gray-700 dark:text-gray-500">15</label>
                </div>
            ...
            <div class="w-full mb-3">
                <div class="flex justify-between items-center">
                    <span class="text-indigo-700 text-xl ">{{ __('Informations de l\'assuré secondaire') }}</span>
            ...
            <div class="w-full mb-3">
                <div class="flex justify-between items-center">
                    <span class="text-indigo-700 text-xl ">{{ __('Enfants') }}</span>
                    <button wire:click.prevent="addChild"
                        class="mb-2 px-8 py-2 bg-indigo-400 border rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500 focus:outline-none focus:border-gray-900 disabled:opacity-25 transition">
            ...
            @foreach ($insureds['children'] as $key => $value)
                <div wire:key="{{ $key }}" class="w-full">
                    <div class="w-full mb-3">
                        <div class="flex justify-between items-center">
                            <span class="text-gray-400 text-xs ">{{ __('Enfant') . ' N°' . $key + 1 }}</span>
                            <button wire:click.prevent="removeChild({{ $key }})"
                            class="mb-2 px-8 py-2 bg-red-400 border rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 focus:outline-none focus:border-gray-900 disabled:opacity-25 transition">
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-4">
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <input wire:model="insureds.children.{{ $key }}.date_naissance" type="date"
                                    class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
                            ...
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <input wire:model="insureds.children.{{ $key }}.code_securite_social" type="text"
                                    class="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow"
                                    placeholder="Code securité social" id="code_securite_social_enf_{{ $key }}" />
    ...
    <button wire:click.prevent="create"
        class="px-8 py-2 bg-indigo-400 border rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500 focus:outline-none focus:border-gray-900 disabled:opacity-25 transition">
        {{ __('Enregistrer') }}
    </button>
</div>
